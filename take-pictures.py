...
jpgFilename = datetime.datetime.utcnow().isoformat() + "Z-test.jpg"
print("taking picture " + jpgFilename)
os.system("libcamera-jpeg --tuning-file /usr/share/libcamera/ipa/rpi/vc4/imx477_af.json --autofocus-mode manual --lens-position 4.4  --o ./photos/" + jpgFilename)
